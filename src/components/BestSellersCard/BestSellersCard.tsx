    ...
    return (
        <div className="flex flex-col releative">
            ...
            <div className='flex gap-2'>
                <button className="w-4 h-4 rounded-full mt-5 cursor-pointer sm:mt-3 md:w-5 md:h-5 xl:w-6 xl:h-6" style={{backgroundColor: cardInfo.color1}}></button>
                <button className="w-4 h-4 rounded-full mt-5 cursor-pointer sm:mt-3 md:w-5 md:h-5 xl:w-6 xl:h-6" style={{backgroundColor: cardInfo.color2}}></button>
                <button className="w-4 h-4 rounded-full mt-5 cursor-pointer sm:mt-3 md:w-5 md:h-5 xl:w-6 xl:h-6" style={{backgroundColor: cardInfo.color3}}></button>
            </div>
