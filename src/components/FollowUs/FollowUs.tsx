    ...
    return (
        <section className="max-w-[1224px] mx-auto px-5 xl:px-0">
            ...
            <div className="grid grid-cols-2 grid-rows-2 md:grid-cols-4 xl:grid-cols-[302px_302px_310px_310px]">
                ...
                <div className="bg-cover bg-center w-full aspect-160/194 xl:w-[310px] xl:h-[375px]
                    bg-[url('/src/assets/images/follow1.jpg')] md:bg-[url('/src/assets/images/follow2.jpg')]"></div>
                <div className="bg-cover bg-center w-full aspect-160/194 xl:w-[310px] xl:h-[375px]
                    bg-[url('/src/assets/images/follow2.jpg')] md:bg-[url('/src/assets/images/follow3.jpg')]"></div>
                <div className="bg-cover bg-center w-full aspect-160/194 xl:w-[310px] xl:h-[375px]
                    bg-[url('/src/assets/images/follow3.jpg')] md:bg-[url('/src/assets/images/follow4.jpg')]"></div>
                <div className="bg-cover bg-center w-full aspect-160/194 xl:w-[310px] xl:h-[375px]
                    bg-[url('/src/assets/images/follow4.jpg')] md:bg-[url('/src/assets/images/follow5.jpg')]"></div>
            </div>
        </section>
    );
};
